    ...
    <div class="container-box">
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
                <h4>Email</h4>
                <ul class="list-style-two">
                    <li><span class="fa fa-envelope"></span> <span id="xload-ge" class="xload-tel" data-file="<?php echo get_template_directory_uri();?>/_noindex/ajax/786a0b4a39efab23" data-scroll="false"></span><script>$(function () { $("#xload-ge").xload(); });</script><noscript><a class="email-info" href="mailto:info@cd-biosciences.com">info@cd-biosciences.com</a></noscript></li>
                </ul>
            </div>
            <div class="col-md-4">
                <h4>Address</h4>
