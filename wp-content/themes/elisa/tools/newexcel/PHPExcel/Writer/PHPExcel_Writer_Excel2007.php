<?php
namespace phpexcel\phpexcel\writer;

use phpexcel\PHPExcel;
use phpexcel\phpexcel\PHPExcel_HashTable;
use phpexcel\phpexcel\PHPExcel_Calculation;
use phpexcel\phpexcel\PHPExcel_Settings;
use phpexcel\phpexcel\shared\PHPExcel_Shared_File;
use phpexcel\phpexcel\calculation\PHPExcel_Calculation_Functions;
use phpexcel\phpexcel\cell\PHPExcel_Cell_DataType;
use phpexcel\phpexcel\writer\PHPExcel_Writer_IWriter;
use phpexcel\phpexcel\writer\PHPExcel_Writer_Abstract;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_StringTable;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_ContentTypes;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_DocProps;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Rels;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Theme;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Style;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Workbook;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Worksheet;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Drawing;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Comments;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_Chart;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_RelsVBA;
use phpexcel\phpexcel\writer\excel2007\PHPExcel_Writer_Excel2007_RelsRibbon;
...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function __construct(PHPExcel $pPHPExcel = null)
    {
		...
		//}
        $this->_writerParts['stringtable']=new PHPExcel_Writer_Excel2007_StringTable($this);
        $this->_writerParts['contenttypes']=new PHPExcel_Writer_Excel2007_ContentTypes($this);
        $this->_writerParts['docprops']=new PHPExcel_Writer_Excel2007_DocProps($this);
        $this->_writerParts['rels']=new PHPExcel_Writer_Excel2007_Rels($this);
        $this->_writerParts['theme']=new PHPExcel_Writer_Excel2007_Theme($this);
        $this->_writerParts['style']=new PHPExcel_Writer_Excel2007_Style($this);
        $this->_writerParts['workbook']=new PHPExcel_Writer_Excel2007_Workbook($this);
        $this->_writerParts['worksheet']=new PHPExcel_Writer_Excel2007_Worksheet($this);
        $this->_writerParts['drawing']=new PHPExcel_Writer_Excel2007_Drawing($this);
        $this->_writerParts['comments']=new PHPExcel_Writer_Excel2007_Comments($this);
        $this->_writerParts['chart']=new PHPExcel_Writer_Excel2007_Chart($this);
        $this->_writerParts['relsvba']=new PHPExcel_Writer_Excel2007_RelsVBA($this);
        $this->_writerParts['relsribbonobjects']=new PHPExcel_Writer_Excel2007_RelsRibbon($this);
