...
<div class="navi-layout">
    ...
    <form id="form-inquiry" name="form-inquiry" class="inquiry-form" method="post" action="http://kinase-phosphatase-biology.141154.cd-web.org/pub.html">
        ...
        <div class="nomain-row-layout" style="justify-content: flex-start;align-items: flex-end;">
            ...
            <div style="display: inline-block">
                <img  src="http://kinase-phosphatase-biology.141154.cd-web.org/?captcha=1&amp;r=1010437475" style="width:120px;height:40px;vertical-align:middle;cursor:pointer;margin-bottom:10px;" onclick="javascript: this.src = 'http://kinase-phosphatase-biology.141154.cd-web.org/?captcha=1&amp;r=' + Math.random()" alt="Verification code" title="Click refresh">
