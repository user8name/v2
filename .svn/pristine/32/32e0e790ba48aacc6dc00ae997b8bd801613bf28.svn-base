...
<head>
    ...
    <script type='text/javascript' src='<?php echo get_template_directory_uri();?>/js/jquery.js?ver=1.12.4-wp'></script>
...
<div class="top-container">
    <div class="top-link">
        <div class="top-email"><span class="fa fa-envelope"></span> <span id="xload-le" class="xload-tel" data-file="<?php echo get_template_directory_uri();?>/_noindex/ajax/786a0b4a39efab23" data-scroll="false"></span><script>$(function () { $("#xload-le").xload(); });</script><noscript><a class="email-info" href="mailto:info@cd-biosciences.com">info@cd-biosciences.com</a></noscript></div>
