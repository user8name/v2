...
<form id="form-inquiry"  name="form-inquiry" autocomplete="off" method="post" action="<?php echo home_url();?>/pub.html" class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <div class="identify-box">
            <input id="code" maxlength="4" type="text" class="validate[required,funcCall[validateNameField2]] form-control" name="code" placeholder="Verification Code *">
...
<script>
    function validateNameField2(field, rules, i, options){
        var value = $("#code").val();
